...
const Select = React.createClass({
	...
	handleMenuScroll (event) {
        ...
        // by browser fractional errors from zoomed screens
        const finishedScrolling = Math.abs(target.scrollHeight - target.offsetHeight - target.scrollTop)
		if (target.scrollHeight > target.offsetHeight && finishedScrolling < 1) {
